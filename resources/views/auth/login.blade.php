                    ...
                    @csrf
                      ...
                      <div class="mb-3">
                        <div class="d-flex justify-content-between">
                          <label class="form-label" for="split-login-password" :value="__('Password')">Kata Laluan</label><a class="fs--1" href="../../../pages/authentication/split/forgot-password.html ">Lupa Kata Laluan?</a>
                        </div>
