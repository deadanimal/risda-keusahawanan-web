...
<div class="card">
    <div class="card-body overflow-hidden p-lg-6">
        <div class="row align-items-center">
            <h3 class="text" style="padding-bottom:20px;color:#00A651;">Laporan Buku Tunai</h3>
                ...
                <table id="insentiftbl">
                    ...
                    <thead>
                        <tr class="align-middle">
                            ...
                            <th scope="col">Laporan Buku Tunai</th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr class="align-middle">
                            ...
                            <td class="text-nowrap" style="text-align: center;">
                                <button class="btn btn-primary btn-sm me-1 mb-1" type="button" onclick="generatereport(11,'/laporanalirantunaiDetail?',{{$user->id}});return false;">
                                Buku Tunai
                            </button></td>
                        </tr>
                        @endforeach
