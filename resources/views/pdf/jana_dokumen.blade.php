...
<body>
    ...
    <div style="margin-left: 1.5cm; margin-right:1.5cm">
        ...
        <p style="text-align: center"><span class="cls_007">QUOTATION</span></p>

        <p style="text-transform: uppercase !important;">
            <span class="cls_008">{{ $pelanggan->nama_pelanggan }}</span>
            <br>
            ...
            <br>
            <span class="cls_008">{{ $pelanggan->poskod }},</span>
            <span class="cls_008 sideBar-text" style="text-transform: uppercase !important">
                {{ $pelanggan->Negeri }}.
            </span>
        </p>
        <p style="text-transform: uppercase !important;">
            <span class="cls_008">
                Tel : {{ $pelanggan->no_telefon }}
            </span>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <span class="cls_008">Fax: {{ $pelanggan->no_fax }}</span>
        </p>

        <div style="position:absolute;left:400.00px;top:227px" class="cls_008">
            <span class="cls_008">Tarikh : {{ $today }}</span>
            <br>
            <span class="cls_008">No
                Rujukan :
                {{ $data->prefix_id }}/Q/{{ $year }}-{{ $pelanggan->id }}</span>
        </div>
    ...
    <div style="margin-left: 1.5cm; margin-right:1.5cm">
        ...
        <p style="text-align: center"><span class="cls_007">DELIVERY ORDER</span></p>
        ...
        <div style="position:absolute;left:400.00px;top:227px" class="cls_008">
            ...
            <span class="cls_008">No
                Rujukan :
                {{ $data->prefix_id }}/DO/{{ $year }}-{{ $pelanggan->id }}</span>
        </div>
    ...
    <div style="margin-left: 1.5cm; margin-right:1.5cm">
        ...
        <p style="text-align: center"><span class="cls_007">INVOICE</span></p>
        ...
        <div style="position:absolute;left:400.00px;top:227px" class="cls_008">
            ...
            <span class="cls_008">No
                Rujukan :
                {{ $data->prefix_id }}/I/{{ $year }}-{{ $pelanggan->id }}</span>
        </div>
