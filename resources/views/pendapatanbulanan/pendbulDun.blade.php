...
<script type="text/javascript">
          ...
          buttons: [
            {
                ...
                titleAttr: 'Copy',
                footer: true,
                title: 'LAPORAN JUMLAH JUALAN / PURATA JUALAN PENERIMA INSENTIF BAGI TAHUN '+yyyy+' MENGIKUT DUN/PARLIMEN'
            },
            {
                extend:    'excelHtml5',
                    ...
                    buttons: [
                      {
                          ...
                          titleAttr: 'Copy',
                          footer: true,
                          title: 'LAPORAN JUMLAH JUALAN / PURATA JUALAN PENERIMA INSENTIF '+jenistext+' BAGI TAHUN '+year+' MENGIKUT DUN/PARLIMEN'
                      },
                      {
                          extend:    'excelHtml5',
                          text:      '<span>Excel</span>',
    ...
    //     window.location.href = "/export3/"+year+"/"+jenis;
    // }

    // function ExportPDF(){
    //     var doc = new jsPDF("p", "mm", "a4")
    //     doc.autoTable({ html: '#pendbuldun' })
    //     doc.save('PendapatanBulananDun.pdf')
    // }
