...
class InsenNegeri implements FromCollection, WithHeadings
{
    /**
    ...
    */
    ...
    public function collection()
    {
        ...
        if($this->tahun == 'nun' && $this->jenis != 'nun'){
            $reports = Report::select('tab1','tab8','tab9','tab2','tab3','tab4','tab5','tab6')->where('type', 4)
    ...
    public function headings(): array
    {
        return [
            ...
            ["NEGERI", "JENIS INSENTIF", "TAHUN TERIMA INSENTIF", "", "JUMLAH INSENTIF", "JUMLAH JUALAN", "PURATA JUALAN"],
            ["", "", ""]
